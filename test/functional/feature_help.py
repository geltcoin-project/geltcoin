...
"""Verify that starting geltcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start geltcoin with -h for help text")
        ...
        self.log.info("Start geltcoin with -version for version information")
        ...
        self.log.info("Start geltcoind with -fakearg to make sure it does not start")
