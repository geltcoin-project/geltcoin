Contributing to Geltcoin Core
============================

The Geltcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Geltcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/geltcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to geltcoin-qt
...
The following applies to code changes to the Geltcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Geltcoin
Network Protocol consensus changes.

Whether a pull request is merged into Geltcoin Core rests with the project merge
...
Patches that change Geltcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Geltcoin consensus, it must have been
...
The project leader is the release manager for each Geltcoin Core release.
