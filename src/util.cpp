...
const char * const BITCOIN_CONF_FILENAME = "geltcoin.conf";
const char * const BITCOIN_PID_FILENAME = "geltcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Geltcoin";
#else
    // Unix
