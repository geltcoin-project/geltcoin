...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " geltcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  geltcoin-tx [options] <hex-tx> [commands]  Update hex-encoded geltcoin transaction\n" +
            "or:     geltcoin-tx [options] -create [commands]   Create hex-encoded geltcoin transaction\n" +
            "\n";
