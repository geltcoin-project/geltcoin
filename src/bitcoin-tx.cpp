...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s geltcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  geltcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded geltcoin transaction") + "\n" +
              "  geltcoin-tx [options] -create [commands]   " + _("Create hex-encoded geltcoin transaction") + "\n" +
              "\n";
