...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 gelts per kB (0.00001 GELTC). This is to prepare for dropping the minimum transaction fee to 0.1 gelts per kB (0.0001 GELTC) in the next release.
