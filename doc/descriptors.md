# Support for Output Descriptors in Geltcoin Core

Since Geltcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `geltc1...` for mainnet or `tgeltc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Geltcoin Core wallets, a convenience function `combo` is
