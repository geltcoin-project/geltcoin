...
bech32_templates = [
  ...
  ('geltc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('geltc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('geltc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('geltc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tgeltc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tgeltc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tgeltc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tgeltc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tgeltc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tgeltc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tgeltc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tgeltc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rgeltc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rgeltc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rgeltc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rgeltc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tgeltc',   17, 32, Encoding.BECH32M, False, False, False),
  ('rgeltc',  3,  1, Encoding.BECH32M, False, False, False),
  ('geltc',   15, 41, Encoding.BECH32M, False, False, False),
  ('tgeltc',    0, 16, Encoding.BECH32,  False, False, False),
  ('rgeltc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('geltc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tgeltc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rgeltc',  0, 20, Encoding.BECH32,  False, False, True),
  ('geltc',    0, 20, Encoding.BECH32M, False, False, False),
  ('tgeltc',    0, 32, Encoding.BECH32M, False, False, False),
  ('rgeltc',  0, 20, Encoding.BECH32M, False, False, False),
  ('geltc',    1, 32, Encoding.BECH32,  False, False, False),
  ('tgeltc',    2, 16, Encoding.BECH32,  False, False, False),
  ('rgeltc', 16, 20, Encoding.BECH32,  False, False, False),
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['geltc', 'tgeltc', 'rgeltc']:
